...
<body class="bg-gradient-warning ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container bg-light mt-5 mb-5 card p-5">
      <h1>Список неподтвержденных аккаунтов</h1>
             <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive" id="showPacientNotActive">
    ...
    $(document).ready(function() {
        ...
        function showAllUsers() {
            $.ajax({
                url: "../php/action.php",
                type: "POST",
                data: { action: "showPacientNotActive" },
                success: function(response) {
                    //console.log(response);
                    $("#showPacientNotActive").html(response);
                    $("table").DataTable({
