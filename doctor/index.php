        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Как прошел прием?</h4>
                    ...
                    <form action="" method="post" id="edit-form-data">
                        <input type="hidden" name="id" id="id">
                          <div class="form-group">
                              <label for="exampleFormControlTextarea1">Есть, что сказать пациенту?</label>
                              <textarea class="form-control" name="comment" id="exampleFormControlTextarea1" rows="3"></textarea>
                            </div>
           
                        <div class="form-group">
                            <input type="submit" name="update" id="update" value="Завершить прием" class="btn btn-primary btn-block">
                        </div>
                    </form>
                </div>
            </div>
...
function showAllUsers() {
    var getUsernameDoctor = document.getElementById("getUsernameDoctor").value;
        ...
        $("body").on("click", ".editBtn", function(e) {
            e.preventDefault();
            edit_Zav = $(this).attr('id');
            $.ajax({
                url: "../php/process.php",
                type: "POST",
                data: { edit_Zav: edit_Zav },
                success: function(response) {
        ...
        $("#update").click(function(e) {
            if ($("#edit-form-data")[0].checkValidity()) {
                ...
                $.ajax({
                    url: "../php/action.php",
                    type: "POST",
                    data: $("#edit-form-data").serialize() + "&action=completeZapis",
                    success: function(response) {
                        Swal.fire({
                            title: 'Прием успешно завершен!',
                            icon: 'success',
                            type: 'success'
                        })
